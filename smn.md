...
* ''LEXICON 2CAACI_SG_DIM'' stem:  čä^RVc^RCi, ke^RVč^RCi
...
We describe here how abbreviations in Inari Sami are read out,
for text-to-speech systems.
...
<small>This (part of) documentation was generated from [src/fst/transcriptions/transcriptor-symbols2text.lexc](https://github.com/giellalt/lang-smn/blob/main/src/fst/transcriptions/transcriptor-symbols2text.lexc)</small>
...
- LIST COM-V = "algâttiđ" "älgiđ" "arvâlâddâđ" "čuákkimistiđ" "elettiđ" "flirttađ" "gávnnadit" "gulahallat" "gulaskuddat" "hilbošit" "išediđ" "juátkiđ" "jyehiđ" "kárvuttiđ" "kištottâllâđ" "lattiđ" "leakkastallat" "lohpádaddat" "lohpádallat" "lonottiđ" "molsođ" "naaijâđ" "oktiibidjat" "ovdániđ" "ovttasbargat" "ovttastahttit" "pallâđ" "pártáskiđ" "piergiđ" "piergiittâllâđ" "reivvestaddat" "rijdâliđ" "rijdáskiđ" "rohcošit" "ruhnođ" "sárnuđ" "servuustâllâđ" "siävuttiđ" "sierâdiđ" "sierâdiđ" "sooppâđ" "soottâđ" "sovâttâllâđ" "šietâdiđ" "teivâđ" "tevdiđ" "tigáštâllâđ" "toimâđ" "tuárruđ" "uápásmiđ" "váivášuđ" "verdidiđ" "viärdádâllâđ" "vijđediđ" "vrd"  ; 
