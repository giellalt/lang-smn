...
morf_codes="+V+Inf \
            +V+Der/tt+V+Ind+Prs+Sg1 \
            +V+Der/tt+V+Ind+Prs+Sg3 \
            +V+Der/tt+V+Ind+Prs+ConNeg \
            +V+Der/tt+V+Ind+Prs+Pl3 \
            +V+Der/tt+V+Ind+Prs+Du1 \
            +V+Der/tt+V+Ind+Prt+Sg1 \
            +V+Der/tt+V+PrfPrc \
            +V+Der/tt+V+Ind+Prs+Du2 \
            +V+Der/tt+V+Ind+Prs+Du3 \
            +V+Der/tt+V+Ind+Prs+Pl1 \
            +V+Der/tt+V+Ind+Prs+Pl2 \
            +V+Der/tt+V+Ind+Prt+Sg3 \
            +V+Der/tt+V+Ind+Prt+Pl1 \
            +V+Der/tt+V+Ind+Prt+Pl3 \
            +V+Der/InchL+V+Ind+Prs+Sg1 \
            +V+Der/InchL+V+Ind+Prs+Sg3 \
            +V+Der/InchL+V+Ind+Prs+ConNeg \
            +V+Der/InchL+V+Ind+Prs+Pl3 \
            +V+Der/InchL+V+Ind+Prs+Du1 \
            +V+Der/InchL+V+Ind+Prt+Sg1 \
            +V+Der/InchL+V+PrfPrc \
            +V+Der/InchL+V+Ind+Prs+Du2 \
            +V+Der/InchL+V+Ind+Prs+Du3 \
            +V+Der/InchL+V+Ind+Prs+Pl1 \
            +V+Der/InchL+V+Ind+Prs+Pl2 \
            +V+Der/InchL+V+Ind+Prt+Sg3 \
            +V+Der/InchL+V+Ind+Prt+Pl1 \
            +V+Der/InchL+V+Ind+Prt+Pl3"
