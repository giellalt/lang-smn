...
export default function smnGramRelease(entry: StringEntry): Command {
  ...
  x = cg3.vislcg3("postspeller-disamb", x, { model_path: "after-speller-disambiguator.bin" });
...
export function localTest_dev(entry: StringEntry): Command {
  ...
  x = cg3.vislcg3("postspeller-disamb", x, { model_path: "@./after-speller-disambiguator.cg3" });
