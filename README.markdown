...
This directory contains source files for the Inari Sami language
...
-   <https://giellalt.uit.no/lang/smn/j-smn.html> (analyser)
...
The Inari Sami language sources can be acquired using [giella SVN
